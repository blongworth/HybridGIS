...
### 2017-07-31 First test 65 and 100um PEEK capillaries
...
### 2017-10-17 100um capillary, second test
...
Same conditions as above. Inlet to source, measured source pressure with source iso GV closed. No discharge observed for any capillary.
...
data <- readResfile(here("Data/USAMS052318RHIGS.txt")) %>% 
  mungeResfile()
...
### Tank CO2 + Helium, Pos 5

23 mbar CO2 frozen in inlet. Added 400 mbar He. Source pressure 8E-7, C12 .4uA. Compress to give source pressure of 4.8E-6, C12 of .6uA.
