...
data <- amstools::readResfile("/mnt/shared/USAMS/Results/USAMS052318RHIGS.txt") %>% mungeResfile()
...
```{r}
sdata %>% mutate(normfm = mean/9.7150433 * 1.0398)
```
...
data <- amstools::readResfile("/mnt/shared/USAMS/Results/USAMS053018R.txt")
