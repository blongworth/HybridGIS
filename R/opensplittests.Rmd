...
data304 <- get_hgis_data(here("data/USAMS030421R.txt"), as.Date("2021-03-05"))
...
data415 <- get_hgis_data(here("data/USAMS041521R.txt"), as.Date("2021-04-16")) 

data <- rbind(data205, data304, data409, data415)
```