...
Goal: constant flow of CO2 to source at correct rate.
...
Closed inlets allow flow control by changing pressure (adding gas) or volume (bellows or syringe) to control gas flow to source.
...
Targets alone and targets + helium produce:
* Fm
