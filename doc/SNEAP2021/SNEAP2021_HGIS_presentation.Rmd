...
Increase flow by
* increasing pCO<sub>2</sub>
* reducing volume

Gas mixtures - partial pressure
* adding another gas increases pressure and total flow
* reduces pCO<sub>2</sub>
* CO<sub>2</sub> remains constant? No- viscosity
]
...
P and V are held constant, so only mixture controls pCO<sub>2</sub>

Use helium to displace CO<sub>2</sub> from vials into split.
...
* Fills vial with CO<sub>2</sub> at 1 atm
...
0.1μA blank current with 10μA total means 1% blank
...
pressure control to maintain constant CO<sub>2</sub> to source
...
.pull-right[![](images/MICADAS_HGIS_interface.jpeg)]
